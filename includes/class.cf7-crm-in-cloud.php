...
class QS_CF7_atp_integration{
	 ...
	 */
     public function __construct() {
          ...
          * @var QS_CF7_CRM_IN_CLOUD_admin
          */
         $this->admin = new QS_CF7_CRM_IN_CLOUD_admin();
     ...
     public function load_dependencies(){
 	    ...
 	    */
         require_once QS_CF7_CRM_IN_CLOUD_INCLUDES_PATH . 'class.cf7-helpers.php';
         /**
        * admin notices class
        */
         require_once QS_CF7_CRM_IN_CLOUD_INCLUDES_PATH . 'class.qs-admin-notices.php';
         /**
        * admin notices clclass
        */
         require_once QS_CF7_CRM_IN_CLOUD_INCLUDES_PATH . 'class-cf7-crm-in-cloud-admin.php';
     }
     /**
