...
class QS_Admin_notices{
    ...
    public function register_hooks(){
         ...
         */
        add_action( 'wp_ajax_qs_cf7_crm_in_cloud_admin_dismiss_notices' , array( $this , 'qs_admin_dismiss_notices' ) );
        /**
    ...
    public function load_admin_scripts(){
        ...
        wp_register_script( 'qs-cf7-crm-in-cloud-admin-notices-script', QS_CF7_CRM_IN_CLOUD_ADMIN_JS_URL . 'admin-notices-script.js' , array( 'jquery' ) , '1.0.25' , true );

        wp_enqueue_script( 'qs-cf7-crm-in-cloud-admin-notices-script' );
    ...
    private function get_plugin_options(){
        ...
        $this->notices_options = apply_filters( 'get_plugin_options' , get_option( 'qs_cf7_crm_in_cloud_notices_options' ) );
    ...
    private function update_plugin_options(){
        ...
        update_option( 'qs_cf7_crm_in_cloud_notices_options' , $this->notices_options );
            ...
            foreach( $this->notices as $admin_notice ){
                ...
                if( ! $admin_notice['dismissable_forever'] || (! isset( $this->notices_options['dismiss_notices'][$id] ) || ! $this->notices_options['dismiss_notices'][$id]) ){
                    if( $admin_notice['dismissable_forever'] ){
                        $classes[] = 'qs-cf7-crm-in-cloud-dismiss-notice-forever';
                    }
